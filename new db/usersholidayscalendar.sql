...
-- Dumping data for table dataprocess.usersholidayscalendar: ~32 rows (approximately)
INSERT INTO `usersholidayscalendar` (`autoId`, `holiday`, `country`, `startDate`, `endDate`, `year`, `symbol`, `zoneArea`, `createdBy`, `createdDate`, `status`) VALUES
	...
	(22, 'Ganthi Jayanthi', 'Asia/Kolkata', '2024-10-02', '2024-10-02', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(23, 'Sunday', 'Asia/Kolkata', '2024-10-06', '2024-10-06', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(24, 'Sunday', 'Asia/Kolkata', '2024-10-13', '2024-10-13', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(25, 'Sunday', 'Asia/Kolkata', '2024-10-20', '2024-10-20', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(27, 'Sunday', 'Asia/Kolkata', '2024-10-27', '2024-10-27', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(28, 'Saturday', 'Asia/Kolkata', '2024-10-05', '2024-10-05', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(29, 'Saturday', 'Asia/Kolkata', '2024-10-12', '2024-10-12', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(30, 'Saturday', 'Asia/Kolkata', '2024-10-19', '2024-10-19', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(31, 'Saturday', 'Asia/Kolkata', '2024-10-26', '2024-10-26', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(32, 'Diwali', 'Asia/Kolkata', '2024-10-31', '2024-10-31', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1'),
	(33, 'Saraswathi Poojai', 'Asia/Kolkata', '2024-10-11', '2024-10-11', 2024, 'Holiday', 'Chennai', NULL, NULL, b'1');
